...
LteRlcDataPdu_Base::LteRlcDataPdu_Base() : ::inet::FieldsChunk()
{
}

LteRlcDataPdu_Base::LteRlcDataPdu_Base(const LteRlcDataPdu_Base& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
LteRlcDataPduDescriptor::LteRlcDataPduDescriptor() : omnetpp::cClassDescriptor("LteRlcDataPdu", "inet::FieldsChunk")
{
...
int LteRlcDataPduDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    ...
    LteRlcDataPdu_Base *pp = omnetpp::fromAnyPtr<LteRlcDataPdu_Base>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}
...
void LteRlcDataPduDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    ...
    LteRlcDataPdu_Base *pp = omnetpp::fromAnyPtr<LteRlcDataPdu_Base>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'LteRlcDataPdu_Base'", field);
    }
}
...
void LteRlcDataPduDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    LteRlcDataPdu_Base *pp = omnetpp::fromAnyPtr<LteRlcDataPdu_Base>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'LteRlcDataPdu_Base'", field);
    }
}
...
omnetpp::cValue LteRlcDataPduDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteRlcDataPdu_Base *pp = omnetpp::fromAnyPtr<LteRlcDataPdu_Base>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'LteRlcDataPdu_Base' as cValue -- field index out of range?", field);
    }
}
