...
RlcFragDescDescriptor::RlcFragDescDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(RlcFragDesc)), "")
{
...
RlcWindowDescDescriptor::RlcWindowDescDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(RlcWindowDesc)), "")
{
    propertyNames = nullptr;
}
...
MrwDescDescriptor::MrwDescDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(MrwDesc)), "")
{
    propertyNames = nullptr;
}
...
RlcUmRxWindowDescDescriptor::RlcUmRxWindowDescDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(RlcUmRxWindowDesc)), "")
{
    propertyNames = nullptr;
}
