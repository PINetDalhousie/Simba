...
const UserTxParams& AmcPilotAuto::computeTxParams(MacNodeId id, const Direction dir, double carrierFrequency)
{
    ...
    if(mode_ == MAX_CQI)
    {
        EV << "AmcPilotAuto::computeTxParams - computing MAX CQI" << endl;
    ...
    {
        EV << "AmcPilotAuto::computeTxParams - computing MIN CQI" << endl;
    ...
    {
        EV << "AmcPilotAuto::computeTxParams - computing AVG CQI" << endl;
    ...
    {
        EV << "AmcPilotAuto::computeTxParams - computing MEDIAN CQI" << endl;
