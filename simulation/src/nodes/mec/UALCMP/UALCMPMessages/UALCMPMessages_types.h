...
#ifndef NODES_MEC_LCMPROXY_LCMPROXYMESSAGES_LCMPROXYMESSAGES_TYPES_H_
#define NODES_MEC_LCMPROXY_LCMPROXYMESSAGES_LCMPROXYMESSAGES_TYPES_H_

#define CREATE_CONTEXT_APP      "CreateContextApp"
#define ACK_CREATE_CONTEXT_APP  "CreateContextAppAck"
