...
Register_Enum(LteTrafficClass, (LteTrafficClass::CONVERSATIONAL, LteTrafficClass::STREAMING, LteTrafficClass::INTERACTIVE, LteTrafficClass::BACKGROUND, LteTrafficClass::UNKNOWN_TRAFFIC_TYPE));
...
Register_Enum(ApplicationType, (ApplicationType::VOIP, ApplicationType::VOD, ApplicationType::WEB, ApplicationType::CBR, ApplicationType::FTP, ApplicationType::GAMING, ApplicationType::FULLBUFFER, ApplicationType::UNKNOWN_APP));

Register_Enum(SchedDiscipline, (SchedDiscipline::DRR, SchedDiscipline::PF, SchedDiscipline::MAXCI, SchedDiscipline::MAXCI_MB, SchedDiscipline::MAXCI_OPT_MB, SchedDiscipline::MAXCI_COMP, SchedDiscipline::ALLOCATOR_BESTFIT, SchedDiscipline::UNKNOWN_DISCIPLINE));
