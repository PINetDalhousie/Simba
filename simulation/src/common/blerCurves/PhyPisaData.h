...
class PhyPisaData
{
    ...
    //SINR_15_CQI_TU [0] [0];
    // int minSnr(){return 0-blerShift_;}
    int minSnr(){
        return -14-blerShift_;
    }

    //SINR_15_CQI_TU [14] [15];}
    // int maxSnr(){return 49-blerShift_;}
    int maxSnr(){
        return 40-blerShift_;
    }

    void setBlerShift( int shift ) {
        blerShift_ = shift;
    }
